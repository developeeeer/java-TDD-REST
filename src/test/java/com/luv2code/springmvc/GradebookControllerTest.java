...
public class GradebookControllerTest {
    ...
    public static void setup () {
        ...
        request.setParameter("emailAddress", "chad@example.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setFirstname("Yuya");
        student.setLastname("Morimoto");
        student.setEmailAddress("yuya@example.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        student.setEmailAddress("chad_darby@example.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("chad_darby@example.com");
    ...
    public void deleteANonValidGradeHttpRequest() throws  Exception {
        mockMvc.perform(delete("/grades/{id}/{gradeType}", 1, "literature"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade wa not found")));
    }
